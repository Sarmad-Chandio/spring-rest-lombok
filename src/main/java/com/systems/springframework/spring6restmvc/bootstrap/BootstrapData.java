package com.systems.springframework.spring6restmvc.bootstrap;
...
import com.systems.springframework.spring6restmvc.model.BeerStyle;
...
import com.systems.springframework.spring6restmvc.service.BeerCsvService;
        ...
        if(beerRepository.count() < 10){
            ...
            csvRecords.forEach(beerCSVRecord -> {
                ...
                beerRepository.save(Beer.builder()
                                ...
                                .beerStyle(String.valueOf(beerStyle))
                                .price(BigDecimal.TEN)
                                .upc(beerCSVRecord.getRow().toString())
                                .quantityOnHold(beerCSVRecord.getCount())
                        .build());
            });
        }
    }
